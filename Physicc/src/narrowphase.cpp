...
Contact checkCollision<BoxCollider, BoxCollider>(Broadphase::PotentialContact a)
{
	...
	return {a.rb1,
			a.rb2,
			glm::vec3(0), // TODO: Supposed to return the contact point, but I gotta figure out how to do that
			collisionAxis,
			minPenetration
	};
}

float NarrowphaseImpl::penetrationAlongAxis(BoxCollider* bc1, BoxCollider* bc2, const glm::vec3 axis)
{
