...
Contact checkCollision<SphereCollider, SphereCollider>(Broadphase::PotentialContact a)
{
	...
	auto sphere1 = std::dynamic_pointer_cast<SphereCollider>(a.rb1->getCollider());
	auto sphere2 = std::dynamic_pointer_cast<SphereCollider>(a.rb2->getCollider());
...
// 	auto box = a.rb1->getCollider();
// 	SphereCollider* sphere = a.rb2->getCollider();
...
// 	// Otherwise returns nothing.
// 	BoxCollider* box1 = a.rb1->getCollider();
// 	BoxCollider* box2 = a.rb2->getCollider();
...
// 	{
// 		tempFloat = CollisionDetector::penetrationAlongAxis(box1, box2, separatingAxes[i]);
// 		if (tempFloat >= 0) {return;}
